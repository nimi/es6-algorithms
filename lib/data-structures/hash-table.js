...
var Hashtable = function () {
  ...
  */
   ...
   */
		...
		key: 'put',
		value: function put(key, data, hashCode) {
   ...
   */
		...
		value: function get(key, hashCode) {
			...
			if (this.buckets[hashCode] === undefined) {
				return undefined;
			} else if (this.buckets[hashCode].next === undefined && this.buckets[hashCode].key === key) {
				return this.buckets[hashCode].data;
			} else {
				var first = this.buckets[hashCode];
				while (first !== undefined && first.next !== undefined && first.key !== key) {
					first = first.next;
				}
   ...
   */
		...
		key: 'remove',
		value: function remove(key, hashCode) {
		...
		key: '_getHashCode',
		value: function _getHashCode(key, hashCode) {
			/*
